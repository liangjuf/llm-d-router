...
import (
	...
	"github.com/llm-d/llm-d-router/pkg/epp/framework/plugins/scheduling/filter/decodepipelinepressure"
...
func (r *Runner) registerInTreePlugins() {
	...
	// Beta
	fwkplugin.Register(crossplugin.KubernetesSyncerType, fwkplugin.StabilityBeta, crossplugin.KubernetesSyncerFactory)
	...
	fwkplugin.Register(decodepipelinepressure.PluginType, fwkplugin.StabilityAlpha, decodepipelinepressure.Factory)
